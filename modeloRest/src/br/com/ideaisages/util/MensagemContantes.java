...
package br.com.ideaisages.util;
...
public class MensagemContantes {
	...
	public static final String MSG_ERR_CAP_JA_EXISTENTE = "Capitulo � j� cadastrado";
	...
	public static final String MSG_ERR_EXCLUIR_BLOCO_JA_GRAVADO = "J� existe doa��o para o Bloco informado!";
