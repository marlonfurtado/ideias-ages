...
public class MensagemContantes {
	...
	public static final String MSG_ERR_EDICAO_USUARIO = "Erro ao editar usu�rio.";
	...
	public static final String MSG_IDEA_ANSWER_SAVED = "D�vida respondida com sucesso.";
