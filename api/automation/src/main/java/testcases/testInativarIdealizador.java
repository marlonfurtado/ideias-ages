...
import tasks.InativarIdealizador;
import tasks.ListarIdealizadorAction;
import tasks.SignInAction;
import utils.Constant;

public class testInativarIdealizador {
	...
	@Test
	public void testInativarIdealizador(){
		Reporter.log("Logando...");
		SignInAction.Execute(driver, utils.Constant.cpf, utils.Constant.senha);
		Reporter.log("Clicando em listar idealizador...");
		ListarIdealizadorAction.Execute(driver);
		Reporter.log("Clicando em Inativar Idealizador...");
		InativarIdealizador.Execute(driver, utils.Constant.cpf);
