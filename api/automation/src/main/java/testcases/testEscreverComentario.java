...
import tasks.EscreverComentariosAction;
import tasks.ListarIdeiasAction;
import tasks.SignInAction;
import utils.Constant;

public class testEscreverComentario {
	...
	@Test
	public void testEscreverComentario(){
		Reporter.log("Logando...");
		SignInAction.Execute(driver, utils.Constant.cpf, utils.Constant.senha);
		Reporter.log("Clicando em listar Ideias...");
		ListarIdeiasAction.Execute(driver);
		Reporter.log("Clicando em Editar Ideia...");
		TelaAcessoObj.getEditarIdeia(driver).click();
		Reporter.log("Clicando em Escrever Comentario");
		EscreverComentariosAction.Execute(driver, utils.Constant.comentario);
