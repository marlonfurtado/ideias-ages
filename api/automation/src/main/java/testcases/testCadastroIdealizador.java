...
import tasks.CadastrarIdealizadorAction;
 ...
 */
public class testCadastroIdealizador  {

    public WebDriver driver = null;
    public String systemDriver = null;

    @Test
    public void testCadastroIdealizador(){
        CadastrarIdealizadorAction.Execute(driver, Constant.nome, Constant.cpf2, Constant.senha, Constant.email, Constant.telefone);
