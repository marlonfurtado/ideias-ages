...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container-fluid" id="header-menu">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/system"><img src="${pageContext.request.contextPath}/assets/img/ages-transparency.png" class="img-responsive" alt="Ideias AGES" title="Ideias AGES" border="0" /></a>
        </div>
