...
<t:system pageTitle="Detalhes da Ideia"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input id="title" name="title" type="text"
							placeholder="Título do projeto (máximo de 100 caracteres)"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input id="goal" name="goal" type="text"
							placeholder="Objetivo do projeto (máximo de 100 caracteres)"
							maxlength="100" class="form-control input-md" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input id="tags" name="tags" type="text"
							placeholder="Utilize o formato 'Área; subárea; tema; tema correlato; referência' (máximo 100 caracteres)"
							maxlength="100" class="form-control input-md" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea maxlength="3000" name="description"
							id="description" class="input-md form-control" required
							placeholder="Descreva o projeto com o máximo de detalhes (máximo de 3000 caracteres)."></textarea>
                    </div>
                </div>
            </form>
        </div>
